        ...
        <div class="container">
            ...
            <form method="get" action="${pageContext.request.contextPath}/UpdateCategoryToDB">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="${categoryObject.getName()}" placeholder="Enter Category Name" name="name" class="form-control">
                </div>
                <div class="form-group">
                    <label for="description">Update Category Description</label>  
                    <textarea  class="form-control" name="description" placeholder="Enter Category Description">${categoryObject.getDescription()}</textarea>
                </div>
